...
public class QuickStart {
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			HttpGet httpGet = new HttpGet("https://hw.weixin.qq.com/steprank/step/personal?openid=o95gOtwEig2YEX_gh40cAAqYfpqA&fromShare=1&from=singlemessage&isappinstalled=0&pass_ticket=65Vk3UU%2BjMTj5Yvb2Ci%2BoGoMt9dAt3LQoVAWPWEpl1A%3D");
...
//			httpGet.setHeader("Q-UA2", "QV=3&PL=ADR&PR=WX&PP=com.tencent.mm&PPVN=6.3.27&TBSVC=36803&CO=BK&COVC=036824&PB=GE&VE=GA&DE=PHONE&CHID=0&LCID=9422&MO= MINOTELTE &RL=1080*1920&OS=6.0.1&API=23");
...
//			httpGet.setHeader("Cookie", "hwstepranksk=WpT4V05Ulj02kkUrJ4BrxFkhIAhNiAd71U9eyt7QZMbFrUeB; pass_ticket=65Vk3UU%2BjMTj5Yvb2Ci%2BoGoMt9dAt3LQoVAWPWEpl1A%3D");
			try {
